...
app.post("/api/runtime/risk-halt", monitorMutationLimiter, requireDashboardAuth, requireSupabaseUser, async (req, res) => {
  try {
...
app.post("/api/runtime/mode", monitorMutationLimiter, requireDashboardAuth, requireSupabaseUser, async (req, res) => {
  try {
    const runtimeUserId = req.supabaseUser?.id || null;
...
app.post("/api/runtime/sizing", monitorMutationLimiter, requireDashboardAuth, requireSupabaseUser, async (req, res) => {
  try {
    const runtimeUserId = req.supabaseUser?.id || null;
